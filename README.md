...
### IMPORTANT NOTE
This fork of Twine adds a Markdown editor to passages, sets the default story format to Snowman and uses a modified version of Snowman to display footnotes. The forked repository for Snowman can be found [here](https://github.com/mensch/snowman). This currently a work in progress and a proof of concept. Due to changes to the passage editor the passage autocompletion feature is currently disabled. Please use the official version of Twine for production work.
